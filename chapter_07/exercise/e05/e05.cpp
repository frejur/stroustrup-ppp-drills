...
// Chapter 7, Exercise 5. Return 'print' when Token_stream encounters '\n'.

// isspace(c) returns true if c is a whitespace char.

// To review relevant sections of the code, search for comments marked: CH07E05
