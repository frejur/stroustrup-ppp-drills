...
// Chapter 7, Exercise 4. Move variable management to class Symbol_table

//	Define a class called Symbol_table with members:
//		vector<Variable> var_table (Contains calculator variables/constants)
//		get()
//		set()
//		is_declared()
//		declare()
//	Rewrite the program to use an instance of this class to manage Calculator
//	variables.

// To review relevant sections of the code, search for comments marked: CH07E04
